...
Object::Object( std::string &name, bool worldDependent ) : 
   _vbuf(0), _ibuf(0), _name(name), _toRender(true), _worldDependent(worldDependent)
{
...
void Object::setWorldDependent( bool value )
{
   _worldDependent = value;
}
