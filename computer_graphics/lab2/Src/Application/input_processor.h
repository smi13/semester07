   ...
   private:
      ...
      void _onKeyDown( T *app, int wParam, long lParam )
      {
         ...
         if (app->_keysPressed['1'])
            app->_scene.getLight("pointlight1")->toggle();
         if (app->_keysPressed['2'])
            app->_scene.getLight("pointlight2")->toggle();
         if (app->_keysPressed['3'])
            app->_scene.getLight("pointlight3")->toggle();
         if (app->_keysPressed['4'])
            app->_scene.getLight("dirlight")->toggle();
         if (app->_keysPressed['5'])
